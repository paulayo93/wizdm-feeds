...
export interface UserExtension {
  onUserCreate: (user: User) => Promise<boolean>,
...
export class AuthService implements OnDestroy {
  ...
  private extensionCreate(user: User): Promise<boolean> {
    return !!this.userExtension && this.userExtension.onUserCreate 
      ? this.userExtension.onUserCreate(user) 
        : Promise.resolve(true);
  }

  private extensionDelete(user: User): Promise<boolean> {
    return !!this.userExtension && this.userExtension.onUserDelete 
      ? this.userExtension.onUserDelete(user) 
        : Promise.resolve(true);
  }
